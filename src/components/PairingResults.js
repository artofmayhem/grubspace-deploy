    ...
    return (
      <div className={"flex flex-col justify-center"}>
        <div className="row bg-gray-600 text-white">0
          ...
          <div
            className={
              "flex flew-row flex-wrap align-center justify-evenly py-20"
            }
          >
            <h2 className={"w-96 py-16 text-3xl "}>{data.pairingText}</h2>
            <div className={"flex flex-col bg-yellow-600 px-10 py-5"}>
              <h3 className={"text-2xl border-b-2 p-4"}>
                Best Wines For Your Meal
              </h3>
              {data.pairedWines &&
            ...
            return (
              ...
              >
                ...
                <div className="my-10 flex-col flex justify-center border-2 py-10 w-96">
                  ...
                  <a
                    href={data.productMatches[index].link}
                    target="_blank"
                    rel="noreferrer"
                    className="m-2"
                  >
